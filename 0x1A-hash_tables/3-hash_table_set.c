...
/**
 * hash_table_set - Sets key-value pair in hash table
 *
 * Description: Inserts or updates key-value pair in hash table. If key already
 * exists, its value is updated; otherwise, a new entry is created.
 *
 * @ht: Hash table
 * @key: Key
 * @value: Value
